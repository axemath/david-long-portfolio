...
<body>  
  <header class="lightborder">
    <h1>Kentucky Derby Data Analysis 2002-2019</h1>
    <h2>by David Long</h2>
  </header>
  
  <!--File Downloads-->
  <section class="lightborder" style="background-color:#63296F;">       
      <div>
          <h3>
              File Downloads
          </h3>
          ...
          <h4>
            The analysis for this project was done with SAS Studio.  The file extension has been changed to .txt for readability.
          </h4>
      </div>
      
      <img src="images/SASlogo.jpg" style="display:block;margin-left: auto;margin-right: auto;height: 30%; width: 30%;">
      
      <nav id="navbar">
          <a href="binLogRegr/logisticRegressionScore.txt" target="_blank" id="navbarAnchor">logisticRegressionScore.txt</a>
      </nav>
    ...
    <section class="darkborder">
      ...
      <div id="derby" class="content darkborder">
        ...
        <h2>Multivariate Analysis of Kentucky Derby Data 2019</h2>
        
        <h3>Summary of Binary Logistic Regression</h3>
        
        <h4 style="color:#00FFFF">The score rankings were last updated on May 4, 2019 with odds from <a href="http://www.kentuckyderby.com/" target="_blank" style="color:#FAFBFE">kentuckyderby.com</a>.  The odds were updated after the race on May 8, 2019 with data from <a href="https://en.wikipedia.org/wiki/2019_Kentucky_Derby" target="_blank" style="color:#FAFBFE">wikipedia.com</a>.</h4>
